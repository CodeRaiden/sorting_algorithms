...
/**
 * get_val - gets relative value of a card from it's string value
...
/**
 * swap_node - swaps a node with next node in the list
 * @list: double pointer to beginning of the list
 * @node: node to swap
 *
 * Return: void
 */
